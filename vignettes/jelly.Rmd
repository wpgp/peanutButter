...
```{r, echo=F, out.width="80%", fig.cap='Applying a user-defined estimate of 5.9 people per building to create gridded population estimates from building footprints for this urban area (darker red = more people).', out.extra='style="border:0px"'}
