...
- Use the disaggregate tool if you have estimates of total population in each administrative unit.
...
## License
You are free to redistribute and modify the peanutButter software under the terms of the <a href="https://www.gnu.org/licenses/gpl-3.0.en.html" source="_blank">GNU General Public License v3.0 (GNU GPLv3)</a>. The source code is openly available from WorldPop on GitHub: <a href="https://github.com/wpgp/peanutButter" target="_blank">https://github.com/wpgp/peanutButter</a>.  

The source data are available for download from the "Source Files" button in the application and the license terms for those datasets are included in the documentation with each download.
