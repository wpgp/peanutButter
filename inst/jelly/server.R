...
function(input, output, session){
  ...
  observeEvent(input$data_select, {
    ...
    tryCatch({
      ...
      # check for rds file
      if(file.exists(file.path(srcdir,fileNames(rv$country_info$country)[['data']]))){
